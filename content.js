...
function main(common) {
    function loadSettings() {
        chrome.storage.local.get(common.storage, data => {
            ...
            document.documentElement.style.setProperty('--yt-simplify-search-voice-display', common.value(data.search_voice_enabled, common.default_search_voice_enabled) ? 'inline-block' : 'none');
            ...
            document.documentElement.style.setProperty('--yt-simplify-create-display', common.value(data.create_enabled, common.default_create_enabled) ? 'inline-block' : 'none');
            ...
            document.documentElement.style.setProperty('--yt-simplify-notifications-display', common.value(data.notifications_enabled, common.default_notifications_enabled) ? 'inline-block' : 'none');
            ...
            document.documentElement.style.setProperty('--yt-simplify-account-display', common.value(data.account_enabled, common.default_account_enabled) ? 'inline-block' : 'none');
