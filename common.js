...
export const default_search_voice_enabled = false;
export const default_create_enabled = false;
export const default_notifications_enabled = true;
export const default_account_enabled = true;
export const default_sidebar_home_enabled = false;
export const default_sidebar_shorts_enabled = false;
export const default_sidebar_subscriptions_enabled = true;
export const default_sidebar_subscriptions_channels_enabled = false;
...
export const default_sidebar_your_videos_enabled = false;
export const default_sidebar_downloads_enabled = true;
export const default_sidebar_music_enabled = false;
export const default_sidebar_movies_enabled = false;
export const default_sidebar_live_enabled = false;
export const default_sidebar_gaming_enabled = false;
export const default_sidebar_news_enabled = false;
export const default_sidebar_sports_enabled = false;
export const default_sidebar_courses_enabled = false;
export const default_sidebar_youtube_premium_enabled = false;
export const default_sidebar_youtube_music_enabled = false;
export const default_sidebar_youtube_kids_enabled = false;
export const default_sidebar_report_history_enabled = false;
export const default_sidebar_about_enabled = false;
